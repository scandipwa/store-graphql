...
namespace ScandiPWA\StoreGraphQl\Model\Resolver\Store;
...
class StoreConfigDataProvider extends \Magento\StoreGraphQl\Model\Resolver\Store\StoreConfigDataProvider
{
    ...
    private function getExtendedConfigData(int $storeId)
    {
        ...
        $extendedConfigData['terms_are_enabled'] = (bool)$this->scopeConfig->isSetFlag(
            'checkout/options/enable_agreements', ScopeInterface::SCOPE_STORE
        );
